...
if [ "$CURRENT_VERSION" != "$TARGET_VERSION" ]; then
	...
	if [ ! -d $TARGET_FOLDER/bin/runtime ]; then
		...
		chmod +x $TARGET_FOLDER/bin/runtime/bin/*.sh;
		chmod +x $TARGET_FOLDER/bin/runtime/*/update.sh;
		chmod +x $TARGET_FOLDER/bin/runtime/*/package.sh;
	...
	$TARGET_FOLDER/bin/configure.sh;
